...
if("TRUE" STREQUAL "TRUE")
  set(publisher_SOURCE_PREFIX /root/testenv/src/publisher)
  set(publisher_DEVEL_PREFIX /root/testenv/devel/.private/publisher)
  ...
  set(publisher_INSTALL_PREFIX /root/testenv/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/testenv/src/publisher/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/testenv/devel/.private/publisher/lib;/root/testenv/devel/lib;/opt/ros/noetic/lib)
